...
spec = importlib.util.spec_from_file_location(
    "ecpay_payment_sdk",
    "ecpay/sdk/ecpay_payment_sdk.py"
)
...
def all():
    order_params = {
        ...
        'TradeDesc': settings['trade_desc'],
        'ItemName': settings['item_name'],
        # 'ReturnURL': 'https://www.ecpay.com.tw/return_url.php',
        'ReturnURL': f'http://127.0.0.1:8000/user/ecpay-result/{settings["user_id"]}/',
        'ChoosePayment': 'ALL',
        ...
        'OrderResultURL':  f'http://127.0.0.1:8000/user/ecpay-result/{settings["user_id"]}/',
        'NeedExtraPaidInfo': 'Y',
        'DeviceSource': '',
        'IgnorePayment': '',
        'PlatformID': '',
